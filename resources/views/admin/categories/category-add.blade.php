            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{route('admin.category.store')}}" enctype="mulTypeart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        <button type="submit" class="btn btn-info me-1 mb-1" name="categoryAdd" value="categoryAdd">Add</button>
                                    </div>
                                </div>
                            </form>
                        </div>
