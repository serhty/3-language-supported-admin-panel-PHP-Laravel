            ...
            <div class="col-12 col-md-9 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Footer Menu Detail</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            <form class="form" method="post" action="{{route('admin.footerMenu.update',$menu->id)}}" enctype="mulTypeart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="row">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <h5>Footer Menu Add</h5>
                            <form class="form" method="post" action="{{route('admin.footerMenu.store')}}" enctype="mulTypeart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-3 col-12">
                                        <div class="form-group">
