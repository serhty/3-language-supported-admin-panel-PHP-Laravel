            ...
            <div class="col-12 col-md-9 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Lates Transection List</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        @foreach($transactions as $transactionsKey => $transaction)
                        <tr>
                            <td>{{Str::limit($transaction['transaction'],90)}}</td>
                            <td>
                            ...
                            <td class="transactionsButtons">
                                <a href="{{route('admin.latestTransaction.edit',$transaction->id)}}">
