            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{route('admin.page.update',$page->id)}}" enctype="mulTypeart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title{{__('lang.lang_db')}}" id="title{{__('lang.lang_db')}}" value="{{$page['title'.__('lang.lang_db')]}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="first-name-column">Link</label>
                                            <input type="text" class="form-control" value="{{$settings['url'.__('lang.lang_db')]}}/{{__('lang.page_link')}}/{{$page['link'.__('lang.lang_db')]}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="first-name-column">Description</label>
                                            <input type="text" class="form-control" name="description{{__('lang.lang_db')}}" id="description{{__('lang.lang_db')}}" value="{{$page['description'.__('lang.lang_db')]}}">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="first-name-column">Keywords</label>
                                            <input type="text" class="form-control" name="keywords{{__('lang.lang_db')}}" id="keywords{{__('lang.lang_db')}}" value="{{$page['keywords'.__('lang.lang_db')]}}">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="first-name-column">Content</label>
                                            <textarea name="content{{__('lang.lang_db')}}" class="ckeditor" id="ckeditor">{{$page['content'.__('lang.lang_db')]}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="card-body image_card">
                                            <div class="row">
                                                <b>Images</b>
                                                @foreach($pageImages as $pageImagesKey => $image)
                                                <div class="col-6 col-sm-6 col-lg-3 image_div">
                                                    <a href="{{asset('public/')}}/images/{{$image->image}}"
                                                    data-fancybox="{{$page['title'.__('lang.lang_db')]}}"
                                                    data-caption="{{$page['title'.__('lang.lang_db')]}}"
                                                    data-speed="700">
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        <button type="submit" class="btn btn-success me-1 mb-1" name="pageUpdate" value="pageUpdate">Update</button>
                                        <button type="submit" class="btn btn-danger me-1 mb-1" name="pageDelete" value="pageDelete">Delete</button>
                                    </div>
                                </div>
                            </form>
                        </div>
